...
export const _X_JSXColumnsComponent = () => {
  ...
  return (
    <>
      ...
      <Table bordered dataSource={data}>
        <ColumnGroup title="Name">
          ...
          <Column
            ...
            key="lastName"
          />
          <ColumnGroup title="Name2" notLast>
            <Column title="First Name" dataIndex="firstName" key="firstName" />
            <Column
              notLast
              title="Last Name"
              ...
              key="lastName"
            />
            <ColumnGroup title="Name3" notLast>
              <Column
                title="First Name"
                dataIndex="firstName"
                key="firstName"
      ...
      {/* <Table rowBgType="cross" bordered dataSource={data}>
        <ColumnGroup title="Name">
          <Column title="First Name" dataIndex="firstName" key="firstName" />
          <Column
            notLast
...
// _Y_TreeComponent.storyName = "表头分组";
