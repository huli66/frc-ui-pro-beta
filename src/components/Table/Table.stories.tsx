...
//     <>
//       <ImportCode code={code} />
//       <Table bordered columns={columns} dataSource={data} height={100} />
//     </>
//   );
// };
...
export const _AT_ExtendComponent = () => {
  ...
  const data: DataType[] = [
    ...
    const newItem: any = { ...item, keys: item.key + "1" };
      ...
      <Table
        ...
        expandable={{
          ...
          expandedRowClassName: (record, index, indent) => {
            // console.log("record, index, indent", record, index, indent);
            return `row-expand-${record.keys}`;
          },
        }}
        dataSource={data}
      />
