  ...
  const fitRowClassName = (record: RecordType, index: number) => {
    ...
    if (
      ...
      if (Date.now() - 50 < record[animeRowKey]) {
        ...
        rowClasses += " frc-table-row-first-gradient-1-8-5";
        ...
        rowClasses += " frc-table-row-first-gradient-1-7-5";
        ...
        rowClasses += " frc-table-row-first-gradient-1-6-5";
        ...
        rowClasses += " frc-table-row-first-gradient-1-5-5";
        ...
        rowClasses += " frc-table-row-first-gradient-1-4-5";
        ...
        rowClasses += " frc-table-row-first-gradient-1-3-5";
        ...
        rowClasses += " frc-table-row-first-gradient-1-2-5";
